...
function ArcStyle(style5, result, compName) {
  keys.forEach((key) => {
...
function OpacityStyle(style5, result, compName) {
  ...
  if (style5["arc-opacity"] !== void 0 && compName === "Arc") {
    result["arc-opacity"] = NormalizeOpacity(style5["arc-opacity"]);
  }
  return result;
}
...
function TextStyle(style5, result, compName) {
  keys10.forEach((key) => {
    if (style5[key] !== void 0) {
      obj9[key](key, style5[key], result);
    }
  });
  if (style5["font-size"]) {
...
var ArcConfig = class {
  ...
  createInstance(newProps, rootInstance, context, workInProgress, uid2) {
    const instance = new ArcComp({ uid: uid2 });
    ...
    src(url) {
      if (url && url !== oldProps.src) {
        ...
        if (!isValidUrl(url)) {
          ...
          tjs.readFile(url, { encoding: "binary" }).then((data) => {
...
function App() {
  ...
  const [birthday, setBirthday] = (0, import_react.useState)("");
  const [showCalendar, setCalendarShow] = (0, import_react.useState)(false);
  return /* @__PURE__ */ import_react.default.createElement(View, {
    ...
    value: birthday,
    autoKeyBoard: false
  }), showCalendar && /* @__PURE__ */ import_react.default.createElement(Mask, {
    onClick: () => {
...
function App3() {
  const [colorListExpand, setColorListExpand] = (0, import_react4.useState)(false);
  const colorListItemsRef = (0, import_react4.useRef)([]);
  const wrapperRef = (0, import_react4.useRef)();
  const colorListRef = (0, import_react4.useRef)();
  return /* @__PURE__ */ import_react4.default.createElement(import_react4.default.Fragment, null, /* @__PURE__ */ import_react4.default.createElement(View, {
    ref: wrapperRef,
    style: style4.window
    ...
    onClick: () => {
      ...
      const width4 = wrapperRef.current.style.width - 20;
      if (!colorListExpand) {
        const animate = Animate.timing({
          ...
          execCallback: (value) => {
            colorListRef.current.setStyle({
              width: Math.floor(value / 256 * (width4 - 60) + 60)
            });
...
Render.render(/* @__PURE__ */ import_react4.default.createElement(App3, null));
/**
 * @license React
