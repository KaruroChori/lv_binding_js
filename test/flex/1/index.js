...
function App() {
  return /* @__PURE__ */ import_react.default.createElement(View, {
  ...
  }, Array(10).fill(0).map((_, i) => /* @__PURE__ */ import_react.default.createElement(Button, {
    style: style.button1
  }, /* @__PURE__ */ import_react.default.createElement(Text, null, `Item: ${i + 1}`)))), /* @__PURE__ */ import_react.default.createElement(View, {
    align: {
    ...
    style: style.button2
  }, /* @__PURE__ */ import_react.default.createElement(Text, null, `Item: ${i + 1}`)))));
}
var style = {
  window: {
    width,
