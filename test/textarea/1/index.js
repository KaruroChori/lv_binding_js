...
// test/textarea/1/index.jsx
var import_react = __toESM(require_react());
var { width, height } = Dimensions.window;
var arr = ["1", "2", "3", "4", "5", "6", "7", "8", "9", "del", "0", "enter"];
function App() {
  ...
  }, arr.map((item) => /* @__PURE__ */ import_react.default.createElement(Button, {
    style: style.button1,
    "data-action": item
  }, /* @__PURE__ */ import_react.default.createElement(Text, null, item)))));
}
var style = {
  window: {
    width,
