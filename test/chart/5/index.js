  ...
  "node_modules/react-reconciler/cjs/react-reconciler.development.js"(exports, module) {
    ...
    if (true) {
      module.exports = function $$$reconciler($$$hostConfig) {
        ...
        {
          var copyWithDeleteImpl = function(obj10, path3, index3) {
            ...
            updated[key] = copyWithDeleteImpl(obj10[key], path3, index3 + 1);
            return updated;
          };
          var copyWithDelete = function(obj10, path3) {
            return copyWithDeleteImpl(obj10, path3, 0);
          };
          var copyWithRenameImpl = function(obj10, oldPath, newPath, index3) {
            ...
            if (index3 + 1 === oldPath.length) {
              ...
              updated[oldKey] = copyWithRenameImpl(obj10[oldKey], oldPath, newPath, index3 + 1);
            }
            return updated;
          };
          ...
          var copyWithSetImpl = function(obj10, path3, index3, value) {
            if (index3 >= path3.length) {
              return value;
            }
            var key = path3[index3];
            var updated = isArray(obj10) ? obj10.slice() : assign({}, obj10);
            updated[key] = copyWithSetImpl(obj10[key], path3, index3 + 1, value);
            return updated;
          };
...
function setArcProps(comp, newProps, oldProps) {
  ...
  Object.keys(newProps).forEach((prop) => {
    const index2 = prop.indexOf("data-");
    if (index2 === 0) {
...
var index = 0;
function App() {
  const [data, setData] = (0, import_react.useState)(Array(50).fill(0).map((item) => [getRandom(0, 200), getRandom(0, 1e3)]));
  (0, import_react.useEffect)(() => {
    setInterval(() => {
      const d = [...data];
      d[index] = [getRandom(0, 200), getRandom(0, 1e3)];
      setData(d);
      index++;
    }, 200);
  }, []);
  return /* @__PURE__ */ import_react.default.createElement(Chart, {
    style: style.chart,
    type: "scatter",
    scatterData: [
      {
