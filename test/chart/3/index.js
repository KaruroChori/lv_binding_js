...
function App() {
  ...
  const [boxesPos, setBoxesPos] = (0, import_react.useState)([]);
  return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement(Chart, {
    ref: chartRef,
    style: style.chart,
    leftAxisData: list,
    align: {
  ...
  }), boxesPos.map((item, i) => /* @__PURE__ */ import_react.default.createElement(View, {
    style: [style.box, { left: item.left, top: item.top, width: item.width, height: item.height }]
