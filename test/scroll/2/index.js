...
function App() {
  ...
  }, Array(2).fill(1).map((item, i) => /* @__PURE__ */ import_react.default.createElement(Button, {
    style: style.button
  }, /* @__PURE__ */ import_react.default.createElement(Text, null, `Panel ${i + 1}`))), /* @__PURE__ */ import_react.default.createElement(Button, {
    style: style.nosnap
  }, /* @__PURE__ */ import_react.default.createElement(Text, null, `Panel 3 no-snap`)), Array(7).fill(1).map((item, i) => /* @__PURE__ */ import_react.default.createElement(Button, {
    style: style.button
  }, /* @__PURE__ */ import_react.default.createElement(Text, null, `Panel ${i + 4}`)))));
}
var style = {
  window: {
    width,
